...
public class New_Employee extends JFrame implements ActionListener{
    ...
    New_Employee(){
        ...
        p1.setLayout(new GridLayout(8,2,10,40));//grid layout divide in row and column(8 row and 2 column and 10 and 40 is spacing)
        l1 = new JLabel("Name");
        ...
        setLayout(new BorderLayout());//for image
