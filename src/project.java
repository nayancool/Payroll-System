...
public class project extends JFrame implements ActionListener {
    ...
    project(){
        ...
        t1.setMnemonic('N');//shortcut key
        t1.setIcon(new ImageIcon(ClassLoader.getSystemResource("icons/New.png")));
        t1.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_N,ActionEvent.CTRL_MASK));//CTRL+N ke liye
        ...
        t4.setFont(new Font("monospaced",Font.PLAIN,12));
        t4.setMnemonic('U');
        t4.setIcon(new ImageIcon(ClassLoader.getSystemResource("icons/EditOpen.png")));
        t4.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_U,ActionEvent.CTRL_MASK));
        ...
        t4.setFont(new Font("monospaced",Font.PLAIN,12));
        t4.setMnemonic('p');
        t4.setIcon(new ImageIcon(ClassLoader.getSystemResource("icon/empreport.png")));
        t4.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_P,ActionEvent.CTRL_MASK));
        ...
        t4.setFont(new Font("monospaced",Font.PLAIN,12));
        t4.setMnemonic('T');
        t4.setIcon(new ImageIcon(ClassLoader.getSystemResource("icon/newexpense.png")));
